...
class AllocationService {
  static async listAllocations(userRole, userId, userDeptId, filters = {}) {
  ...
  static async allocateAsset(data, user) {
  ...
  static async returnAsset(id, data, userId) {
    return db.transaction(async (trx) => {
  ...
  static async listTransfers(userRole, userId, userDeptId) {
  ...
  static async raiseTransfer(data, user) {
    return db.transaction(async (trx) => {
  ...
  static async approveTransfer(id, userId) {
    return db.transaction(async (trx) => {
