...
router.post("/", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
...
router.post("/:id/return", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/transfers/:id/approve", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/transfers/:id/reject", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
