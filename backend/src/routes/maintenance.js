...
router.post("/:id/approve", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/:id/assign", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/:id/resolve", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/:id/reject", authenticateJWT, requireRole(["AssetManager", "Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
