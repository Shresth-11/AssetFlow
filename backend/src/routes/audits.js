...
router.get("/cycles", authenticateJWT, async (req, res) => {
  try {
...
router.get("/cycles/:id", authenticateJWT, async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/cycles", authenticateJWT, requireRole(["Admin"]), async (req, res) => {
  try {
...
router.post("/cycles/:id/results", authenticateJWT, async (req, res) => {
  try {
    const { id } = req.params;
...
router.post("/cycles/:id/close", authenticateJWT, requireRole(["Admin"]), async (req, res) => {
  try {
    const { id } = req.params;
...
router.get("/cycles/:id/report", authenticateJWT, async (req, res) => {
  try {
    const { id } = req.params;
