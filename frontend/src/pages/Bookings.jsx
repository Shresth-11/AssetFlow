...
import { Plus, Clock, MapPin, Grid, CalendarDays, Sparkles } from "lucide-react";
...
export const Bookings = () => {
  ...
  const [selectedSchedulerAssetId, setSelectedSchedulerAssetId] = useState("");
  ...
  const [resAcqCost, setResAcqCost] = useState("");
  const [resCondition, setResCondition] = useState("New");
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const bookable = (assetsData.assets || []).filter((a) => a.is_bookable);
  ...
  const openBookingDrawer = (asset, initialStartTime) => {
              ...
              <div className="modal-body">
                ...
                <div className="form-row">
                  ...
                  <div className="form-group">
                    ...
                    <select className="form-control" value={resCondition} onChange={(e) => setResCondition(e.target.value)}>
