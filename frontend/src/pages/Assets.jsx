...
import { Box, Search, Plus, QrCode, FileText } from "lucide-react";
...
export const Assets = () => {
  ...
  const [activeProfileAsset, setActiveProfileAsset] = useState(null);
  const [profileTab, setProfileTab] = useState("alloc");
  ...
  const handleOpenProfile = async (asset) => {
