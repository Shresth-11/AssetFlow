...
import { Plus, RotateCcw, AlertTriangle, ArrowRightLeft } from "lucide-react";
...
export const Allocations = () => {
  ...
  const triggerTransferRequest = async (aId) => {
    try {
          ...
          <div className="card" style={{ display: "flex", alignItems: "center", justifyContent: "center", textAlign: "center" }}>
            <div>
              ...
              <p style={{ fontSize: "13px", color: "var(--text-secondary)", maxWidth: "280px", marginTop: "4px" }}>
                Only designated <strong>Asset Managers</strong> can issue physical assets to staff or offices.
              </p>
            </div>
          </div>
        )}
            ...
            <form onSubmit={handleReturnSubmit}>
              <div className="modal-body">
                <p style={{ fontSize: "14px", marginBottom: "16px" }}>
                  Please verify the state of asset <strong>{returningAlloc.asset_name} ({returningAlloc.asset_tag})</strong> before confirming its return.
                </p>
                <div className="form-group">
