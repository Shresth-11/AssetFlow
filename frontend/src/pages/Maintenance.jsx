...
import { Plus, X, UserCheck, Play, CheckCircle, Sparkles } from "lucide-react";
...
export const Maintenance = () => {
  ...
  const handleStartWork = async (req) => {
    try {
  ...
  const columns = [
    { id: "Pending", title: "Pending", count: getColTickets("Pending").length },
    { id: "Approved", title: "Approved", count: getColTickets("Approved").length },
    { id: "TechnicianAssigned", title: "Technician assigned", count: getColTickets("TechnicianAssigned").length },
    { id: "InProgress", title: "in progress", count: getColTickets("InProgress").length },
    { id: "Resolved", title: "Resolved", count: getColTickets("Resolved").length },
  ];
