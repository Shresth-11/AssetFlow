...
export const Dashboard = () => {
  ...
  const [regAcqCost, setRegAcqCost] = useState("");
    ...
    <div className="animate-fade">
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            const toggleBtn = document.querySelector(".ai-copilot-toggle-btn");
              ...
              <div className="modal-body">
                ...
                <div className="form-row">
                  <div className="form-group">
                    ...
                    <select className="form-control" value={regCondition} onChange={(e) => setRegCondition(e.target.value)}>
